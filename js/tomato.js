...
function imageDancing() {
    if ($tomato.attr('src') == 'IMAGE FILE/tomato-cartoon.svg') {
        $tomato.attr('src', 'IMAGE FILE/tomato-cartoon-1.svg');
    } else if ($tomato.attr('src') == 'IMAGE FILE/chill-Tomato-cartoon.svg') {
        $tomato.attr('src', 'IMAGE FILE/chill-Tomato-cartoon-1.svg');
    } else if ($tomato.attr('src') == 'IMAGE FILE/chill-Tomato-cartoon-1.svg') {
        $tomato.attr('src', 'IMAGE FILE/chill-Tomato-cartoon.svg');
    } else if ($tomato.attr('src') == 'IMAGE FILE/tea-tomato-cartoon.svg') {
        $tomato.attr('src', 'IMAGE FILE/tea-tomato-cartoon-1.svg');
    } else if ($tomato.attr('src') == 'IMAGE FILE/tea-tomato-cartoon-1.svg') {
        $tomato.attr('src', 'IMAGE FILE/tea-tomato-cartoon.svg');
    } else {
        $tomato.attr('src', 'IMAGE FILE/tomato-cartoon.svg');
    }
}
...
function notify(message) {
    new Notification(message, {
        icon: 'http://localhost/project/tomato/IMAGE FILE/favicon.png',
    });
}
